...
function findWasmBinary() {
  return locateFile('CompileResource.wasm');
}
...
//FORWARDED_DATA:{"librarySymbols":["ExitStatus","HEAP32","HEAP8","HEAPU32","addOnPostRun","onPostRuns","callRuntimeCallbacks","addOnPreRun","onPreRuns","noExitRuntime","ptrToString","stackRestore","stackSave","warnOnce","wasmMemory","__abort_js","__tzset_js","stringToUTF8","stringToUTF8Array","HEAPU8","lengthBytesUTF8","_emscripten_resize_heap","getHeapMax","alignMemory","growMemory","_environ_get","getEnvStrings","ENV","getExecutableName","_environ_sizes_get","_fd_close","SYSCALLS","PATH","FS","randomFill","initRandomFill","PATH_FS","TTY","UTF8ArrayToString","UTF8Decoder","findStringEnd","FS_stdin_getChar","FS_stdin_getChar_buffer","intArrayFromString","MEMFS","mmapAlloc","FS_modeStringToFlags","FS_fileDataToTypedArray","FS_getMode","strError","UTF8ToString","ERRNO_CODES","FS_createPreloadedFile","FS_preloadFile","asyncLoad","FS_createDataFile","getUniqueRunDependency","addRunDependency","runDependencies","resolveRunDependencies","dependenciesPromise","removeRunDependency","dependenciesPromiseResolve","runDependencyTracking","runDependencyWatcher","FS_handledByPreloadPlugin","preloadPlugins","HEAP64","_fd_read","doReadv","_fd_seek","bigintToI53Checked","INT53_MAX","INT53_MIN","_fd_write","doWritev","exitJS","_proc_exit","keepRuntimeAlive","runtimeKeepaliveCounter","handleException","requestFullscreen","Browser","callUserCallback","maybeExit","_exit","getFullscreenElement","safeSetTimeout"],"nativeAliases":{"wasmMemory":"memory"},"warnings":false,"asyncFuncs":[],"libraryDefinitions":{},"ATPRERUNS":"callRuntimeCallbacks(onPreRuns);","ATMODULES":"if (Module['noExitRuntime']) noExitRuntime = Module['noExitRuntime'];\n\nif (Module['print']) out = Module['print'];\nif (Module['printErr']) err = Module['printErr'];","ATINITS":"if (!Module['noFSInit'] && !FS.initialized) FS.init();\nTTY.init();","ATPOSTCTORS":"FS.ignorePermissions = false;","ATMAINS":"","ATPOSTRUNS":"callRuntimeCallbacks(onPostRuns);","ATEXITS":""}
