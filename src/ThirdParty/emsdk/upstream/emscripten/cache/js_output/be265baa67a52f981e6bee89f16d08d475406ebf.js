...
function findWasmBinary() {
  return locateFile('_9bea2d427b9c31443eb2ed57f681d5df.wasm');
}
...
//FORWARDED_DATA:{"librarySymbols":["ExitStatus","HEAP32","HEAP8","HEAPU32","addOnPostRun","onPostRuns","callRuntimeCallbacks","addOnPreRun","onPreRuns","noExitRuntime","ptrToString","stackRestore","stackSave","warnOnce","wasmMemory","_fd_close","SYSCALLS","UTF8ToString","UTF8ArrayToString","UTF8Decoder","findStringEnd","HEAPU8","_fd_seek","bigintToI53Checked","INT53_MAX","INT53_MIN","_fd_write","flush_NO_FILESYSTEM","printChar","printCharBuffers","exitJS","_proc_exit","keepRuntimeAlive","runtimeKeepaliveCounter","handleException","stringToUTF8OnStack","lengthBytesUTF8","stringToUTF8","stringToUTF8Array","stackAlloc"],"nativeAliases":{"wasmMemory":"memory"},"warnings":false,"asyncFuncs":[],"libraryDefinitions":{},"ATPRERUNS":"callRuntimeCallbacks(onPreRuns);","ATMODULES":"if (Module['noExitRuntime']) noExitRuntime = Module['noExitRuntime'];\nif (Module['print']) out = Module['print'];\nif (Module['printErr']) err = Module['printErr'];\n\nModule['FS_createDataFile'] = FS.createDataFile;\nModule['FS_createPreloadedFile'] = FS.createPreloadedFile;\n","ATINITS":"","ATPOSTCTORS":"","ATMAINS":"","ATPOSTRUNS":"callRuntimeCallbacks(onPostRuns);","ATEXITS":""}
