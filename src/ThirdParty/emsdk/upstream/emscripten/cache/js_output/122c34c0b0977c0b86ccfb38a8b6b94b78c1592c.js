...
function findWasmBinary() {
  return locateFile('MiniGame-Mesh.wasm');
}
...
//FORWARDED_DATA:{"librarySymbols":["ExitStatus","HEAP32","HEAP8","HEAPU32","addOnPostRun","onPostRuns","callRuntimeCallbacks","addOnPreRun","onPreRuns","noExitRuntime","ptrToString","stackRestore","stackSave","warnOnce","wasmMemory","___assert_fail","UTF8ToString","UTF8ArrayToString","UTF8Decoder","findStringEnd","HEAPU8","___cxa_throw","ExceptionInfo","uncaughtExceptionCount","__abort_js","__tzset_js","stringToUTF8","stringToUTF8Array","lengthBytesUTF8","_emscripten_get_canvas_element_size","findCanvasEventTarget","findEventTarget","maybeCStringToJsString","specialHTMLTargets","_emscripten_get_now","_emscripten_resize_heap","getHeapMax","alignMemory","growMemory","_emscripten_set_canvas_element_size","_emscripten_set_keydown_callback_on_thread","registerKeyEventCallback","JSEvents","addOnExit","onExits","getWasmTableEntry","wasmTableMirror","wasmTable","HEAPF64","_emscripten_set_keyup_callback_on_thread","_emscripten_set_main_loop_arg","setMainLoop","MainLoop","callUserCallback","handleException","maybeExit","_exit","exitJS","_proc_exit","keepRuntimeAlive","runtimeKeepaliveCounter","_emscripten_set_main_loop_timing","_emscripten_set_mousedown_callback_on_thread","registerMouseEventCallback","fillMouseEventData","getBoundingClientRect","HEAP16","_emscripten_set_mousemove_callback_on_thread","_emscripten_set_mouseup_callback_on_thread","_emscripten_set_resize_callback_on_thread","registerUiEventCallback","_emscripten_set_touchend_callback_on_thread","registerTouchEventCallback","_emscripten_set_touchmove_callback_on_thread","_emscripten_set_touchstart_callback_on_thread","_emscripten_set_wheel_callback_on_thread","registerWheelEventCallback","_emscripten_webgl_create_context","GL","GLctx","webgl_enable_ANGLE_instanced_arrays","webgl_enable_OES_vertex_array_object","webgl_enable_WEBGL_draw_buffers","webgl_enable_WEBGL_draw_instanced_base_vertex_base_instance","webgl_enable_WEBGL_multi_draw_instanced_base_vertex_base_instance","webgl_enable_EXT_polygon_offset_clamp","webgl_enable_EXT_clip_control","webgl_enable_WEBGL_polygon_mode","webgl_enable_WEBGL_multi_draw","getEmscriptenSupportedExtensions","registerPreMainLoop","webglBufferSubData","_emscripten_webgl_do_create_context","webglPowerPreferences","_emscripten_webgl_destroy_context","_emscripten_webgl_make_context_current","_environ_get","getEnvStrings","ENV","getExecutableName","_environ_sizes_get","_fd_close","SYSCALLS","PATH","FS","randomFill","initRandomFill","PATH_FS","TTY","FS_stdin_getChar","FS_stdin_getChar_buffer","intArrayFromString","MEMFS","mmapAlloc","FS_modeStringToFlags","FS_fileDataToTypedArray","FS_getMode","strError","ERRNO_CODES","FS_createPreloadedFile","FS_preloadFile","asyncLoad","FS_createDataFile","getUniqueRunDependency","addRunDependency","runDependencies","resolveRunDependencies","dependenciesPromise","removeRunDependency","dependenciesPromiseResolve","runDependencyTracking","runDependencyWatcher","FS_handledByPreloadPlugin","preloadPlugins","HEAP64","_fd_read","doReadv","_fd_seek","bigintToI53Checked","INT53_MAX","INT53_MIN","_fd_write","doWritev","_glActiveTexture","_emscripten_glActiveTexture","_glAttachShader","_emscripten_glAttachShader","_glBindBuffer","_emscripten_glBindBuffer","_glBindBufferBase","_emscripten_glBindBufferBase","_glBindFramebuffer","_emscripten_glBindFramebuffer","_glBindTexture","_emscripten_glBindTexture","_glBindVertexArray","_emscripten_glBindVertexArray","_glBlendEquation","_emscripten_glBlendEquation","_glBlendFunc","_emscripten_glBlendFunc","_glBufferData","_emscripten_glBufferData","_glBufferSubData","_emscripten_glBufferSubData","_glClear","_emscripten_glClear","_glClearColor","_emscripten_glClearColor","_glClearDepthf","_emscripten_glClearDepthf","_glCompileShader","_emscripten_glCompileShader","_glCreateProgram","_emscripten_glCreateProgram","_glCreateShader","_emscripten_glCreateShader","_glCullFace","_emscripten_glCullFace","_glDeleteBuffers","_emscripten_glDeleteBuffers","_glDeleteFramebuffers","_emscripten_glDeleteFramebuffers","_glDeleteProgram","_emscripten_glDeleteProgram","_glDeleteShader","_emscripten_glDeleteShader","_glDeleteTextures","_emscripten_glDeleteTextures","_glDeleteVertexArrays","_emscripten_glDeleteVertexArrays","_glDepthFunc","_emscripten_glDepthFunc","_glDepthMask","_emscripten_glDepthMask","_glDetachShader","_emscripten_glDetachShader","_glDisable","_emscripten_glDisable","_glDisableVertexAttribArray","_emscripten_glDisableVertexAttribArray","_glDrawArrays","_emscripten_glDrawArrays","_glDrawElements","_emscripten_glDrawElements","_glDrawElementsInstanced","_emscripten_glDrawElementsInstanced","_glEnable","_emscripten_glEnable","_glEnableVertexAttribArray","_emscripten_glEnableVertexAttribArray","_glFlush","_emscripten_glFlush","_glFramebufferTexture2D","_emscripten_glFramebufferTexture2D","_glGenBuffers","_emscripten_glGenBuffers","_glGenTextures","_emscripten_glGenTextures","_glGenVertexArrays","_emscripten_glGenVertexArrays","_glGetProgramInfoLog","_emscripten_glGetProgramInfoLog","_glGetProgramiv","_emscripten_glGetProgramiv","_glGetShaderInfoLog","_emscripten_glGetShaderInfoLog","_glGetShaderiv","_emscripten_glGetShaderiv","_glGetString","_emscripten_glGetString","stringToNewUTF8","webglGetExtensions","_glGetUniformBlockIndex","_emscripten_glGetUniformBlockIndex","_glGetUniformLocation","_emscripten_glGetUniformLocation","jstoi_q","webglPrepareUniformLocationsBeforeFirstUse","webglGetLeftBracePos","_glLinkProgram","_emscripten_glLinkProgram","_glMapBufferRange","_emscripten_glMapBufferRange","emscriptenWebGLGetBufferBinding","emscriptenWebGLValidateMapBufferTarget","_glPolygonOffset","_emscripten_glPolygonOffset","_glScissor","_emscripten_glScissor","_glShaderSource","_emscripten_glShaderSource","_glTexImage2D","_emscripten_glTexImage2D","emscriptenWebGLGetTexPixelData","computeUnpackAlignedImageSize","colorChannelsInGlTextureFormat","heapObjectForWebGLType","HEAPU16","HEAPF32","toTypedArrayIndex","_glTexParameteri","_emscripten_glTexParameteri","_glTexSubImage2D","_emscripten_glTexSubImage2D","_glUniform1i","_emscripten_glUniform1i","webglGetUniformLocation","webglGetProgramUniformLocation","_glUniformBlockBinding","_emscripten_glUniformBlockBinding","_glUnmapBuffer","_emscripten_glUnmapBuffer","_glUseProgram","_emscripten_glUseProgram","_glVertexAttribPointer","_emscripten_glVertexAttribPointer","_glViewport","_emscripten_glViewport","requestFullscreen","Browser","getFullscreenElement","safeSetTimeout"],"nativeAliases":{"wasmMemory":"memory","wasmTable":"__indirect_function_table"},"warnings":false,"asyncFuncs":[],"libraryDefinitions":{},"ATPRERUNS":"callRuntimeCallbacks(onPreRuns);","ATMODULES":"if (Module['noExitRuntime']) noExitRuntime = Module['noExitRuntime'];\n\nif (Module['print']) out = Module['print'];\nif (Module['printErr']) err = Module['printErr'];","ATINITS":"if (!Module['noFSInit'] && !FS.initialized) FS.init();\nTTY.init();","ATPOSTCTORS":"FS.ignorePermissions = false;","ATMAINS":"","ATPOSTRUNS":"callRuntimeCallbacks(onPostRuns);","ATEXITS":"callRuntimeCallbacks(onExits);"}
